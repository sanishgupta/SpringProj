...
package com.dev.app1.springmvc.controller;
...
import com.dev.app1.springmvc.model.FileBucket;
import com.dev.app1.springmvc.model.User;
import com.dev.app1.springmvc.model.UserDocument;
import com.dev.app1.springmvc.service.UserDocumentService;
import com.dev.app1.springmvc.service.UserService;
import com.dev.app1.springmvc.util.FileValidator;
			...
			ModelMap model)
	{
		...
		if ( !userService.isUserSSOUnique(user.getId(), user.getSsoId()) )
		{
			FieldError ssoError = new FieldError(
					"user", "ssoId", messageSource.getMessage("non.unique.ssoId", new String[] {
							user.getSsoId() }, Locale.getDefault()));
